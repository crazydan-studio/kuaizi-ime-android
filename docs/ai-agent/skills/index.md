...
> **项目命名规范**：三层模块命名、UI 组件后缀、已更名对照等项目特定的命名规范，详见 [v4 命名规范](../v4/design/010-naming-conventions.md)。
...
项目特定章节的示例必须使用本项目的真实类名，并反映最新设计。命名规范以 [v4 命名规范](../v4/design/010-naming-conventions.md)为准。
