...
| 020 | [全局状态模型](020-ime-state.md) | ImeState 完整 8 字段定义、Keyboard/CandidateList/Clipboard/FavoriteList/ToolListState 子状态、ImeEffect 副作用通道（PopupTip.Message/Action、PlayAudio、PlayHaptic）、Feature 门控规则、状态不变式、状态频率分层 |
