...
**ViewModel 组件（UI 协调中心）**：

| 组件 | 包路径 | 说明 | 对应设计文档 |
|------|--------|------|------------|
| `KeyboardViewModel` | `viewmodel` | UI 层协调中心，持有 ImeEngine，暴露 `StateFlow<ImeState>`，将 InputGesture 转换为 ImeIntent，管理 GestureFeedbackState | [050-KeyboardViewModel](../ui/050-keyboard-view-model.md) |
