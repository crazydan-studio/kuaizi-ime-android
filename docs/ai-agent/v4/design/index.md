...
| [060-输入动作程序化](engine/060-input-action.md) | InputAction sealed class、InputActionScript、InputActionScriptCompiler、InputActionPlaybackState、InputActionFingerIndicator（兼作行指示器）、InputActionPathInterpolator、InputActionPositionResolver、OffsetF/RectF 归一化坐标类型 |
...
| [040-输入动作播放](ui/040-input-action-player.md) | KeyboardInputActionPlayerHost、UseMode、ComposeInputActionPositionResolver、InputActionPlayer、行指示器内建机制、InputActionScriptLoader |
