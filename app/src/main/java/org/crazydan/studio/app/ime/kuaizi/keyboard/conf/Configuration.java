...
package org.crazydan.studio.app.ime.kuaizi.keyboard.conf;
...
public class Configuration implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public boolean isLatinUsePinyinKeysInXInputPadEnabled() {
        return bool(Conf.enable_latin_use_pinyin_keys_in_x_input_pad) && get(Conf.ime_subtype) == ImeSubtype.hans;
    }
