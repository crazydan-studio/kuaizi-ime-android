...
package org.crazydan.studio.app.ime.kuaizi.keyboard.sub.keytable;
...
public class PinyinKeyTable extends KeyTable {
    ...
    public Key<?>[][] createKeys() {
        ...
        return (Key<?>[][]) new Key[][] {
                ...
                , new Key[] {
                keyboardSwitchKey(Keyboard.Subtype.Math),
                symbolKey("？").withReplacements("?"),
                ...
                , new Key[] {
                keyboardSwitchKey(Keyboard.Subtype.Latin),
                // 😄
                emojiKey("\uD83D\uDE04"),
                symbolKey("；").withReplacements(";"),
    ...
    protected XPadKey createXPadKey() {
        ...
        return xPadKey(Keyboard.Subtype.Pinyin, new Key[][][] {
                new Key[][] {
