...
public abstract class KeyTable {
    ...
    public CtrlKey keyboardSwitchKey(Keyboard.Subtype type) {
     ...
     *         </ul>
     */
    protected XPadKey xPadKey(Keyboard.Subtype activeKeyboard, Key<?>[][][] zone_2_keys) {
        Key<?>[] zone_1_keys = new Key[] {
                keyboardSwitchKey(Keyboard.Subtype.Latin).setIconResId(R.drawable.ic_latin),
                keyboardSwitchKey(Keyboard.Subtype.Pinyin).setIconResId(R.drawable.ic_pinyin),
                keyboardSwitchKey(Keyboard.Subtype.Number).setIconResId(R.drawable.ic_number),
                null,
                null,
                keyboardSwitchKey(Keyboard.Subtype.Math).setIconResId(R.drawable.ic_math),
                };
