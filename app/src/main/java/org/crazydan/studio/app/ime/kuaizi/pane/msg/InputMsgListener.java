...
public interface InputMsgListener extends KeyboardMsgListener, InputListMsgListener {
    ...
    @Override
    default void onMsg(Keyboard keyboard, KeyboardMsg msg, KeyboardMsgData msgData) {}

    @Override
    default void onMsg(InputList inputList, InputListMsg msg, InputListMsgData msgData) {}
}
