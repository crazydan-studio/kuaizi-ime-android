...
package org.crazydan.studio.app.ime.kuaizi.keyboard.key;
...
public class CtrlKey extends BaseKey<CtrlKey> {
    ...
    public static class KeyboardSwitchOption extends Option<Keyboard.Subtype> {
        public KeyboardSwitchOption(Keyboard.Subtype value) {
            super(value);
        }
    }
