...
import org.crazydan.studio.app.ime.kuaizi.pane.key.BaseCharKey;
import org.hexworks.mixite.core.api.HexagonOrientation;

/**
 * {@link BaseCharKey} 视图的 {@link RecyclerView.ViewHolder}
 *
 * @author <a href="mailto:flytreeleft@crazydan.org">flytreeleft</a>
 * @date 2023-09-18
 */
public abstract class BaseCharKeyViewHolder<T extends BaseCharKey<?>> extends KeyViewHolder<T, TextView> {
