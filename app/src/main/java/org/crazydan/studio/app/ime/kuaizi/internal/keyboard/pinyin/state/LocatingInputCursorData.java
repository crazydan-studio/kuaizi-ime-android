 ...
 * @date 2023-07-19
 */
public class LocatingInputCursorData implements State.Data {
    private Motion anchor = new Motion();

    public Motion getAnchor() {
        return this.anchor;
    }

    public void updateAnchor(Motion motion) {
