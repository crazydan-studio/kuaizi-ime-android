...
public class ExerciseMain extends FollowSystemThemeActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setExerciseActiveListener((exerciseView) -> {
            exerciseView.getTextView().requestFocus();

            this.imeView.removeInputMsgListenerByType(exerciseView.getTextView().getClass());
            this.imeView.addInputMsgListener(exerciseView.getTextView());
