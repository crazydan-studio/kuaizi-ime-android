...
import org.crazydan.studio.app.ime.kuaizi.keyboard.input.EmojiWord;
...
import org.crazydan.studio.app.ime.kuaizi.keyboard.sub.state.CandidatePinyinWordAdvanceFilterDoingStateData;
import org.crazydan.studio.app.ime.kuaizi.keyboard.sub.state.CandidatePinyinWordChooseDoingStateData;
...
/**
 * {@link Keyboard.Subtype#Pinyin 汉语拼音键盘}
 *
...
public class PinyinKeyboard extends BaseKeyboard {
    ...
    public Keyboard.Subtype getType() {
        return Keyboard.Subtype.Pinyin;
    }
