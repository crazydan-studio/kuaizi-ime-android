...
public class KeyboardConfig {
    ...
    /** 键盘类型 */
    private final Keyboard.Subtype type;

    /** 当前键盘是从哪个类型的键盘切换过来的，以便于退出时切换到原键盘 */
    private Keyboard.Subtype switchFromType;
    /** 是否为单行输入 */
    ...
    public KeyboardConfig(Keyboard.Subtype type) {
        this.type = type;
    }

    public KeyboardConfig(Keyboard.Subtype type, KeyboardConfig config) {
        this(type);
    ...
    public Keyboard.Subtype getSwitchFromType() {
        return this.switchFromType;
    }

    public void setSwitchFromType(Keyboard.Subtype switchFromType) {
