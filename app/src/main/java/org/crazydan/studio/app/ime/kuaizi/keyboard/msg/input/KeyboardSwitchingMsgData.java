...
/**
 * {@link KeyboardMsg#Keyboard_Switch_Doing}
 * 和 {@link KeyboardMsg#Keyboard_Switch_Done} 的消息数据
 *
 * @author <a href="mailto:flytreeleft@crazydan.org">flytreeleft</a>
 * @date 2023-07-27
 */
public class KeyboardSwitchingMsgData extends InputCommonMsgData {
    public final Keyboard.Subtype target;

    public KeyboardSwitchingMsgData(Key<?> key, Keyboard.Subtype target) {
        super(key);
