...
data class UiConfigBackupEntry(
    ...
    fun restoreFromBackup(current: ImeConfig.Ui): ImeConfig.Ui {
        return current.copy(
            keyboardHandMode = keyboard_hand_mode?.let { KeyboardHandMode.valueOf(it) } ?: current.keyboardHandMode,
            keyboardThemeType = keyboard_theme_type?.let { KeyboardThemeType.valueOf(it) } ?: current.keyboardThemeType,
