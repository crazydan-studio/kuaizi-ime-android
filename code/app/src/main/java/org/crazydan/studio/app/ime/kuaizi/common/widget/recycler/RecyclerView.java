...
public abstract class RecyclerView<A extends RecyclerViewAdapter<I, ?>, I>
    ...
    /** 查找与指定坐标下的视图所绑定的 {@link RecyclerViewAdapter} 数据项 */
    public I findAdapterItemUnder(float x, float y) {
        View view = findChildViewUnder(x, y);
        return getAdapterItem(view);
    }

    /** 查找与指定坐标下的视图所绑定的 {@link RecyclerViewAdapter} */
    public <V extends RecyclerViewHolder> V findViewHolderUnder(float x, float y) {
        View view = findChildViewUnder(x, y);
